...
questions_data = {
    ...
    "構想 (Vision)": [
        ...
        "5年後や10年後といった長期で、夢や目標に向かって、具体的な計画が進んでいる",
        "未来のことを考えるとワクワクする",
        "将来「こうなっていたい」という理想のライフスタイルが描けている。",
    ...
    "繋がり (Connection)": [
        ...
        "人を愛したり愛されているという実感がある",
        "一緒にいて「一番自分らしくいられる」と感じる人が身近にいる",
        "一人で何かしようとしたときに、応援や手伝ってくれる人がいる。",
